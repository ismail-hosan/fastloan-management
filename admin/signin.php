  ...
  <div class="container">
    <form class="form-signin" action="" method="POST">
      <div class="text-center mb-4">
        <img class="mb-2" src="images/fast-loan-logo.png" alt="" width="220" height="auto">
    ...
    <br>
     ...
     <div class="row">
      ...
      <div class="col-md-12 ">
        <p class="text-muted text-center"><a href="#">Fast Loan</a> &copy; 2022 All rights reserved.</p></div>
    </div> -->
    </div>
  </body>
</html>
