    ...
    <div class="container-fluid">
      <div class="row row-offcanvas row-offcanvas-right">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#user-pages" aria-expanded="false" aria-controls="user-pages">
                <img src="images/user.png" alt="">
                <span class="menu-title">All Users<i class="fa fa-sort-down"></i></span>
              </a>
              <div class="collapse" id="user-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="viewuser.php">All Users</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="signup.php">Add Users</a>
                  </li>
                </ul>
              </div>
            </li>
        ...
        <?php } ?>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#settings-pages" aria-expanded="false" aria-controls="settings-pages">
              ...
              <div class="collapse" id="settings-pages">
                <ul class="nav flex-column sub-menu">
                  <?php if(Session::get("role") == 3) { ?>
                  <li class="nav-item">
                    <a class="nav-link" href="mailer-settings.php">SMTP Mailer</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="interest-rates.php">Interest Rates</a>
                  </li>
                  <?php } ?>
                  <li class="nav-item">
